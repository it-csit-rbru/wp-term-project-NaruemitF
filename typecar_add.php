            ...
            <div class="row">
                ...
                <?php
                    if(isset($_GET['submit'])){
                        ...
                        $sql = "insert into typecar (tc_typeb) values ('$tc_typeb')";
                        include 'connectdb.php';
                        mysqli_query($conn,$sql);
                        mysqli_close($conn);
                        echo "เพิ่มประเภทรถ $tc_typeb เรียบร้อยแล้ว<br>";
                        echo '<a href="typecar_list.php">แสดงประเภทรถทั้งหมด</a>';
                    }else{
                ?>
                    <form class="form-horizontal" role="form" name="typecar_add" action="<?php echo $_SERVER['PHP_SELF']?>">
                        <div class="form-group">
                            <label for="tc_typeb" class="col-md-2 col-lg-2 control-label">ชื่อประเภทรถ</label>
                            <div class="col-md-10 col-lg-10">
                                <input type="text" name="tc_typeb" id="tc_typeb" class="form-control">
                            </div>    
                        </div>
                        <div class="form-group">
                            <div class="col-md-10 col-lg-10">
